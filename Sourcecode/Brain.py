...
print("**********************************************")
print("Project Title  --Brain Tumor Detection ")
print("**********************************************")
print()
...
tf.keras.models.save_model(model,'brainmodel.h5')
...
plt.show()
import tensorflow as tf
model = tf.keras.models.load_model('brainmodel.h5')
#=================================Prediction===================================
