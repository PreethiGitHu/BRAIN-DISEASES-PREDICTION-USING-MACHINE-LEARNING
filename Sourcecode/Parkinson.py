...
print("**********************************************")
print("Project Title  --Parkinson Disease Detection ")
print("**********************************************")
print()
...
tf.keras.models.save_model(model,'Parkinson.h5')
...
plt.show()
import tensorflow as tf
model = tf.keras.models.load_model('Parkinson.h5')
#=================================Prediction===================================
